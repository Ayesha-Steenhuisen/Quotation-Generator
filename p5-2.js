...
let wisdomQuotes = {
    ...
    fragment1: ["Every time you stay out late; every time you sleep in;",
    ...
    fragment2: ["every time you miss a workout; every time you don’t give 100% – ",
    ...
    fragment3: ["You make it that much easier for me to beat you. – Unknown",
...
while (true) {
    ...
    let typeWhichQuote = prompt('Which quote would you like? Type 1 for inspiration quote or 2 for a wisdom quote.');
    ...
    while (true) {
        if (numberOfQuotes < 1 || numberOfQuotes > 5) {
            numberOfQuotes = prompt("Please type how many quotes you like. Please pick a number: 1, 2, 3, 4, or 5.");
        } else {
            break;
        }
    }
    ...
    for (let i = 0; i < numberOfQuotes; i++) {
        ...
        alert(quotes.fragment1[randomNumber(quotes.fragment1.length)] + quotes.fragment2[randomNumber(quotes.fragment2.length)] + quotes.fragment3[randomNumber(quotes.fragment3.length)]);
    }
}